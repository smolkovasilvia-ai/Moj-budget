const CACHE='mami-nudim-sa-v3-20260813';
const ASSETS=['./','./index.html','./styles.css','./app-v3.js','./data-v3.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
